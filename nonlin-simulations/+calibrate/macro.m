...
x.c1_roc_y_tnd = 0.005; % Hysteresis in GDP


% Forward output
x.c1_fws_y = 0.5; % Response in discount factor to lending conditions
...
x.c1_roc_re_tnd = 0.001; % Hysteresis in real exchange rate
