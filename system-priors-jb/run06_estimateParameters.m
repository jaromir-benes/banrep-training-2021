...
d2 = neighbors(pos2, linspace(0.95, 1.05, 50));
plotNeighbors(pos2, d2);
...
d = zerodb(mest1, 1:40);
d.eps_dl_cpi_targ(1) = -1;
s = simulate(mest, d, 1:40, 'deviation', true, 'prependInput', true);
...
[~, x] = filter(mest, h, histRange, "meanOnly", true, "initUnit", "approxDiffuse");
